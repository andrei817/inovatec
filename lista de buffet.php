...
include("php/Config.php");
 ...
 // Consulta SQL para buscar buffets
    ...
    <tbody>
        ...
        while ($buffet = mysqli_fetch_assoc($result)): ?>
            <tr>
                ...
                <td class="actions">
                <a href="edit buffet.php?id=<?php echo $buffet['id']; ?>"> <button class='btn-edit'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
...
<a href="delete Buffet.php?id=<?php echo $buffet['id']; ?>"><button class='btn-delete' > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
...
<!-- Modal -->
<div id="confirmationModal2" class="modal-delete">
    <div class="modal-content-delete">
      <p>Tem certeza que deseja excluir esse buffet?</p>
  ...
  <script>
    ...
    function openModal() {
      document.getElementById("confirmationModal2").style.display = "block";
    }
    ...
    function confirmDelete() {
      closeModal();
                      ...
                      window.location.href = "delete Buffet.php?id=<?php echo $buffet['id']; ?>" // Exemplo de redirecionamento
                  }
   
    // Função para confirmar a exclusão
    function confirmDelete() {
      closeModal();
      alert("Buffet excluído com sucesso!");
      // Aqui você pode adicionar a lógica de exclusão do buffet
    }
  </script>
